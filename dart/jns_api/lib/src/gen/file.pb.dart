...
class GetFileRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'file.v1'),
...
class GetDirRequest extends $pb.GeneratedMessage {
  ...
  factory GetDirRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetDirRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetDirRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'file.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetDirRequest copyWith(void Function(GetDirRequest) updates) =>
      super.copyWith((message) => updates(message as GetDirRequest))
          as GetDirRequest;
  ...
  static $pb.PbList<GetDirRequest> createRepeated() =>
      $pb.PbList<GetDirRequest>();
  @$core.pragma('dart2js:noInline')
  static GetDirRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetDirRequest>(create);
...
class GetDirResponse extends $pb.GeneratedMessage {
  ...
  factory GetDirResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetDirResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetDirResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'file.v1'),
      createEmptyInstance: create)
    ..a<$core.List<$core.int>>(
        1, _omitFieldNames ? '' : 'tar', $pb.PbFieldType.OY)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  GetDirResponse copyWith(void Function(GetDirResponse) updates) =>
      super.copyWith((message) => updates(message as GetDirResponse))
          as GetDirResponse;
  ...
  static $pb.PbList<GetDirResponse> createRepeated() =>
      $pb.PbList<GetDirResponse>();
  @$core.pragma('dart2js:noInline')
  static GetDirResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetDirResponse>(create);
  static GetDirResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get tar => $_getN(0);
  @$pb.TagNumber(1)
  set tar($core.List<$core.int> v) {
    $_setBytes(0, v);
  }
